...
map_file = "./PPARG/PPARG_labelmap.txt"
...
if test_mode == "missense":
    if vcf_filename == "./PPARG/PPARG_vepout.vcf":
        vcf_outfilename = "./PPARG/PPARG_vepout.csv"
...
label_mapping = {'Likely_pathogenic':'1', 'Likely_benign':'-1', 'Pathogenic':'1', 'Benign':'-1', 'Pathogenic/Likely_pathogenic':'1','Benign/Likely_benign':'-1','not':'-1','pathogenic':'1'}
