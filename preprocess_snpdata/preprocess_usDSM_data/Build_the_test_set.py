...
clinvar_2022_idfilename = './03data_graph/clinvar_2022/var.label.tsv'
...
if test_mode == "missense":
    if filename == "./clinvar/clinvar_20230326/00clinvar_20230326_selected.csv":
        ...
        out_filename = "./cancer_gnomad/cancer_discover_test.csv"
    elif filename == "./LOF_GOF/goflof_HGMD2019_with_gnomAD.csv":
        out_filename = "./LOF_GOF/goflof_HGMD2019_with_gnomAD_test.csv"
    elif filename == "./cancer_gnomad/cancer_gnomAD.csv":
        out_filename = "./cancer_gnomad/00cancer_gnomAD_test.csv"
