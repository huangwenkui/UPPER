...
if test_mode == "missense":
    ...
    if filename == "./clinvar/clinvar_20230326/01clinvar_2023other_than_missense_test_getfeature.csv":
        out_filename = "./clinvar/clinvar_20230326/02clinvar_2023other_than_missense_test_standard.csv"
