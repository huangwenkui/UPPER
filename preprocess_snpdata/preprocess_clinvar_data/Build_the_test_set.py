...
if test_mode == "missense":
    ...
    elif filename == "./clinvar/clinvar_20230410/00clinvar_20230410_selected.csv":
        out_filename = "./clinvar/clinvar_20230410/00clinvar_20230410_test.csv"
    elif filename == "./LOF_GOF/goflof_HGMD2019_with_gnomAD.csv":
        out_filename = "./LOF_GOF/goflof_HGMD2019_with_gnomAD_test.csv"
    elif filename == "./cancer_gnomad/cancer_Discover_vepout.csv":
        out_filename = "./cancer_gnomad/00cancer_Discover_test.csv"
elif test_mode == "other_than_missense":
    if filename == "./clinvar/clinvar_20230326/00clinvar_2023other_than_missense_selected.csv":
        out_filename = "./clinvar/clinvar_20230326/00clinvar_2023other_than_missense_test.csv"
    elif filename == "./gnomAD/00ExAC_for_other_than_missense.csv":
        out_filename = "./gnomAD/00ExAC_for_other_than_missense_test.csv"
