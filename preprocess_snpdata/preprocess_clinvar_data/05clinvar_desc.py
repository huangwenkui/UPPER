...
if test_mode == "missense":
    ...
    if filename == "./clinvar/clinvar_20230326/02clinvar_2023other_than_missense_test_standard.csv":
        out_filename = "./clinvar/clinvar_20230326/03clinvar_2023other_than_missense_test_desc.csv"
