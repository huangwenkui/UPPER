...
if vcf_filename == "./TP53/TP53_test_vepout.vcf":
    vcf_outfilename = "./TP53/TP53_test_vepout.csv"
vcf_reader = vcf.Reader(open(vcf_filename, 'r'))
test_mode = sys.argv[1:][1]


map_file = "./TP53/TP53_labelmap_from_metaRNN.txt"
...
label_mapping = {'Likely_pathogenic':'1', 'Likely_benign':'-1', 'Pathogenic':'1', 'Benign':'-1', 'Pathogenic/Likely_pathogenic':'1','Benign/Likely_benign':'-1','not':'-1','pathogenic':'1','non-functional':'1','functional':'-1',"TP":"1","TN":"-1"}
...
for reader in vcf_reader:
    ...
    try:
        True_Label = label_mapping[label_map[key_id]]
    except:
        continue
    try:
