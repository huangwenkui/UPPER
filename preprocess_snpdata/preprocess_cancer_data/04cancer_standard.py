...
if test_mode == "missense":
    if filename == "./cancer_gnomad/01cancer_gnomAD_test_getfeature.csv":
        out_filename = "./cancer_gnomad/02cancer_gnomAD_test_standard.csv"
    elif filename == "./cancer_gnomad/01cancer_discover_test_getfeature.csv":
        out_filename = "./cancer_gnomad/02cancer_discover_test_standard.csv"
