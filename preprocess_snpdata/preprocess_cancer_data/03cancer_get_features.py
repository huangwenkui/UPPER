...
if test_mode == "missense":
    if filename == "./cancer_gnomad/00cancer_gnomAD_test.csv":
        out_filename = "./cancer_gnomad/01cancer_gnomAD_test_getfeature.csv"
    elif filename == "./cancer_gnomad/cancer_discover_test.csv":
        out_filename = "./cancer_gnomad/01cancer_discover_test_getfeature.csv"
