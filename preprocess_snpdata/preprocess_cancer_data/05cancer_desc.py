...
if test_mode == "missense":
    if filename == "./cancer_gnomad/02cancer_gnomAD_test_standard.csv":
        out_filename = "./cancer_gnomad/03cancer_gnomAD_test_desc.csv"
    elif filename == "./cancer_gnomad/02cancer_discover_test_standard.csv":
        out_filename = "./cancer_gnomad/03cancer_discover_test_desc.csv"
