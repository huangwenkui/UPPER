...
if vcf_filename == "./gnomAD/ExAC_vepout4.vcf":
    vcf_outfilename = "./gnomAD/00ExAC_vepout4.csv"
vcf_reader = vcf.Reader(open(vcf_filename, 'r'))
test_mode = sys.argv[1:][1]
if test_mode == "missense":
    if vcf_filename == "./gnomAD/missense_gnomad_vepout.vcf":
        vcf_outfilename = "./gnomAD/00missense_gnomad_vepout.csv"
elif test_mode == "other_than_missense":
    if vcf_filename == "./gnomAD/other_gnomad_vepout.vcf":
        vcf_outfilename = "./gnomAD/00other_gnomad_vepout_value.csv"
        # vcf_outfilename = "./gnomAD/00other_gnomad_vepout.csv"
