...
label_mapping = {'Likely_pathogenic':'1', 'Likely_benign':'-1', 'Pathogenic':'1', 'Benign':'-1', 'Pathogenic/Likely_pathogenic':'1','Benign/Likely_benign':'-1','-1':'-1','1':'1'}
...
if filename == "./clinvar/clinvar_20220620/03clinvar_20220620_selected_desc.csv":
    name = "clinvar_20220620"
elif filename == "./clinvar/clinvar_20230326/03clinvar_20230326_test_desc.csv":
    name = "clinvar_20230326"
elif filename == "./clinvar/clinvar_20230326/03clinvar_2023other_than_missense_test_desc.csv":
    name = "clinvar_2023other_than_missense"
elif filename == "./clinvar/clinvar_20220620/03clinvar_2022other_than_missense_test_desc.csv":
    name = "clinvar_2022other_than_missense"
elif filename == "./gnomAD/03ExAC_for_other_than_missense_desc.csv":
    name = "gnomAD_for_other_than_missense"
else:
    print("error")
id_data = []
score_data = []
