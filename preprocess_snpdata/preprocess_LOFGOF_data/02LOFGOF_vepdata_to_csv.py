...
pathogenicity_mapping = {'Likely_pathogenic':'1', 'Likely_benign':'-1', 'Pathogenic':'1', 'Benign':'-1', 'Pathogenic/Likely_pathogenic':'1','Benign/Likely_benign':'-1'}
mapping_file = sys.argv[1:][0]
map_fp = open(mapping_file,'r')
map = {}
for line in map_fp:
    arr = line.strip().split("\t")
    # print(arr)
    map[arr[0]] = arr[1]
vcf_filename = sys.argv[1:][1]
if vcf_filename == "./LOF_GOF/goflof_HGMD2019_hgvsc_vepout.vcf":
    vcf_outfilename = "./LOF_GOF/goflof_HGMD2019_vepout.csv"
...
# CSQ=G|missense_variant|MODERATE|MKKS|8195|Transcript|NM_018848.3|protein_coding|3/6||||1720|830|277|L/P|cTt/cCt|||-1||EntrezGene||NP_061336.1|rseq_mrna_match||A|A|||D|0.272397|28.3|4.158812|D|0.690691113471985|0.99914743471206935|D&D|0.879728&0.879728|ENSG00000125863&ENSG00000125863|ENSP00000246062&ENSP00000382008|ENST00000347364&ENST00000399054|T&T|-1.46&-1.46|5.72|5.72|1.0|.&T|.&0.743326|N|0.001414|D|0.107899|0.63698446731&.|0.968966548421&0.968966548421|D&D|0.9508306&0.9508306|D|0.2307||M&M|2.745&2.745|A&A|1&1|D&D|-3.09&-3.09|D&D|0.984&0.984|T|0.504851460457|0.825&0.825|D&D|0.002&0.002|D&D|0.004&0.004|Q9NPJ1&Q9NPJ1|G|20|C1858054&C0950123&CN517202|605231||Conflicting_interpretations_of_pathogenicity|NC_000020.11:g.10412685A>G|Bardet-Biedl_syndrome_6&Inborn_genetic_diseases&not_provided|OMIM_Allelic_Variant:604896.0008&UniProtKB_(protein):Q9NPJ1#VAR_009884|MKKS&MKKS|1.312000|A|rs74315398,G|missense_variant|MODERATE|MKKS|8195|Transcript|NM_170784.2|protein_coding|3/6||||1610|830|277|L/P|cTt/cCt|||-1||EntrezGene||NP_740754.1|rseq_mrna_match||A|A|||D|0.272397|28.3|4.158812|D|0.690691113471985|0.99914743471206935|D&D|0.879728&0.879728|ENSG00000125863&ENSG00000125863|ENSP00000246062&ENSP00000382008|ENST00000347364&ENST00000399054|T&T|-1.46&-1.46|5.72|5.72|1.0|.&T|.&0.743326|N|0.001414|D|0.107899|0.63698446731&.|0.968966548421&0.968966548421|D&D|0.9508306&0.9508306|D|0.2307||M&M|2.745&2.745|A&A|1&1|D&D|-3.09&-3.09|D&D|0.984&0.984|T|0.504851460457|0.825&0.825|D&D|0.002&0.002|D&D|0.004&0.004|Q9NPJ1&Q9NPJ1|G|20|C1858054&C0950123&CN517202|605231||Conflicting_interpretations_of_pathogenicity|NC_000020.11:g.10412685A>G|Bardet-Biedl_syndrome_6&Inborn_genetic_diseases&not_provided|OMIM_Allelic_Variant:604896.0008&UniProtKB_(protein):Q9NPJ1#VAR_009884|MKKS&MKKS|1.312000|A|rs74315398,G|intron_variant&non_coding_transcript_variant|MODIFIER|MKKS|8195|Transcript|NR_072977.2|misc_RNA||2/4||||||||||-1||EntrezGene|||rseq_mrna_match||A|A|||
...
for reader in vcf_reader:
    ...
    label = CSQ_arr[CSQ_format_arr_mapping['clinvar_clnsig']]
    True_Label = "1"
    id = reader.ID
    LOFGOF = map[id]
    CHROM = reader.CHROM
    ...
    Ensembl_Gene_ID = CSQ_arr[CSQ_format_arr_mapping['Ensembl_geneid']]
    if Ensembl_Gene_ID == "":
        continue
